...
Sie verarbeitet Eingaben aus externen Systemen und von Hardware-Komponenten und führt deren Stopp befehle aus. Außerdem ist es Aufgabe des Systems, das diese Stopps geloggt und zurückvollziehbar sind.
...
\begin{figure}[H]
  ...
  \caption{Illustration des Zonenmodells als Grundlage TTC-basierter Entscheidungen (Normalbetrieb vs. Intervention/Safety) Quelle: Stimac}
  \label{fig:zones_ttc}
\end{figure}
