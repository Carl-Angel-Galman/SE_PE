...
kann dessen Funktionen \textbf{blinkCyclic\_WarningLight()}
und \textbf{toggle\_SoftstopLED()} aufrufen, um die Signalisierung entsprechend der aktuellen Systemzustände zu steuern.
