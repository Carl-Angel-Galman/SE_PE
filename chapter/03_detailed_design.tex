...
\paragraph{SoftStop}
\begin{itemize}[leftmargin=*, itemsep=2pt]
  \item \textbf{onEntry():} \texttt{stopRequest()}, Warn-LEDs blinken, Softstop-LED aktivieren,
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  \item \textbf{onEntry():} Driving aktivieren, LEDs deaktivieren, \texttt{logStateChange(...)}.
...
\paragraph{HardStop}
\begin{itemize}[leftmargin=*, itemsep=2pt]
  \item \textbf{onEntry():} \texttt{stopRequest()}, Warn-LEDs blinken, Softstop-LED an, \\
        \texttt{logStateChange(...)}.
...
\paragraph{Error}
\begin{itemize}[leftmargin=*, itemsep=2pt]
  \item \textbf{onEntry():} \texttt{stopRequest()}, Warn-LEDs blinken, Softstop-LED an, Logging des Zustandswechsels.
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  \item Warnlicht ist in allen Stop-/Error-Zuständen aktiv.
