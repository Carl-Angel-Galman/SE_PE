...
\begin{itemize}[leftmargin=*, itemsep=2pt]
  ...
  aktuelle Soll-Geschwindigkeit. Diese wird zyklisch aktualisiert (vgl. Sequenzdiagramm~\ref{fig:dd_seq_speedcontrol}).
...
\[
  \texttt{Error} \;>\; \texttt{HardStop} \;>\; \texttt{SoftStop} \;>\; \texttt{NormalOperation}
\]
